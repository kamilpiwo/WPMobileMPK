...
namespace PhoneApp4
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private void punkt_A_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            punkt_A.SelectAll(); 
        }

        private void punkt_B_Tap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            punkt_B.SelectAll();
        }
